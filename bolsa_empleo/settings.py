...
SECRET_KEY = 'django-insecure-i1=%&^tz%qale=j#8u3*u1adoo=afg-@hu%8&f9fxwq$e+&vpn'
...
DEFAULT_FROM_EMAIL = os.environ.get('DEFAULT_FROM_EMAIL', f"Empleos Loja <{EMAIL_HOST_USER}>")
